...
Each game inside the suite is rendered on a hardware-accelerated Compose `Canvas` with separate tick loops and state models. Here are the core mechanics of each of the 5 games:
